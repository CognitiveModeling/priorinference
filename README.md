...
Visit the [website](https://haniaelkersh.github.io/priorinference/docs/index.html) to look at the documentation of the [functions](https://haniaelkersh.github.io/priorinference/docs/reference/index.html).
